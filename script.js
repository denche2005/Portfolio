...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Data Science & Engineering student at UPC working at",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "the intersection of AI, Data, and Software.",
      "#ffffff"
    )}
${this.wrapWithColor(
  "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor(
  "   Building AI-powered applications in sports analytics,",
  "#ffffff"
)}
${this.wrapWithColor("   data systems, and software products", "#ff8c00")}

${this.wrapWithColor("⚡ Mindset", "#ff8c00")}
${this.wrapWithColor(
  "   Analytical and mathematical thinker. Builder, not just",
  "#ffffff"
)}
${this.wrapWithColor(
  "   analyst. Curious and always shipping.",
  "#ffffff"
)}

${this.wrapWithColor("⚡ Background", "#ff8c00")}
${this.wrapWithColor(
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "AI • Data • Software — finding the intersection",
      "#ffffff"
...
╚═════╝ ╚══════╝╚═╝  ╚═══╝   ╚═╝   ╚══════╝`;
    ...
    role.textContent = "AI • Data • Software";
